...
// LookbackHours accepts legacy integer hours and explicit whole-day/hour units
// through the official gcfg decoder, without requiring a private runner loader.
