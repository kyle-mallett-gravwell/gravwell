// Package microsoft implements one private Hosted Runner plugin for
// stable, read-only Microsoft cloud APIs that are not completely covered by a
// current native Gravwell ingester.
package microsoft
